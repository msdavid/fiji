...
async def list_events(
    ...
    try:
        ...
        for event_data in temp_event_data_list:
            is_signed_up = user_assignments.get(event_data['id']) is not None if current_rbac_user else None 
            assignment_status = user_assignments.get(event_data['id']) if is_signed_up else None 
