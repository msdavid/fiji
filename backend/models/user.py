...
class UserCreate(UserBase):
    # This model is typically used for self-registration where user provides password.
    # For admin creation, password will be auto-generated by backend.
    pass

class UserAdminCreatePayload(BaseModel):
    """Payload for admin creating a new user. Password is auto-generated by backend."""
    email: EmailStr = Field(..., description="User's email address.")
    ...
    status: Literal["active", "disabled", "pending_verification"] = Field(default="pending_verification", description="Initial account status.")
    assignedRoleIds: Optional[List[str]] = Field(default_factory=list, description="List of role IDs to assign initially.")
    # Other fields like phone, skills can be added here if settable at creation by admin
...
class UserUpdate(BaseModel):
    ...
    notes: Optional[str] = None # Added notes for admin updates
    
    assignedRoleIds: Optional[List[str]] = None # For admin updates
    status: Optional[Literal["active", "disabled", "pending_verification"]] = None # For admin updates
...
class UserInDBBase(UserBase):
    ...
    notes: Optional[str] = Field(None, description="Administrative notes about the user.") # Added notes
...
class UserAdminCreateResponse(UserResponse):
    """Response after admin creates a user, includes the auto-generated password."""
    generatedPassword: str = Field(..., description="The auto-generated initial password for the new user.")
