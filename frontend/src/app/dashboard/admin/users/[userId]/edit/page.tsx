        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <section className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div><label htmlFor="phone" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Phone Number</label><input type="tel" name="phone" id="phone" value={formData.phone || ''} onChange={handleChange} className={baseInputStyles} placeholder="+65 9123 4567" /></div>
